...
// export const ONE_INCH_CONTRACTS = {
...
// 	42161: "",
// };
// export const ONE_INCH_SWAP_CONTRACTS = {
...
// export const get1InchBaseURL = (networkId: any) => {
...
// 			const simplePredicate = and(timestampBelow(expiration));
...
// 			const limitOrderSignature =
// 				await limitOrderBuilder.buildOrderSignature(
// 					walletAddress,
// 					limitOrderTypedData
// 				);
...
// 				makerAmount: ethers.utils
// 					.parseUnits("" + makerAmount, 18)
// 					.toString(),
// 				takerAmount: ethers.utils
// 					.parseUnits("" + takerAmount, 18)
// 					.toString(),
// 				createDateTime: new Date(),
// 				data: limitOrder,
// 			};
// 			await axios.post(
// 				ONE_INCH_BASE_URL + network + ONE_INCH_LIMT_URL,
// 				data
// 			);
// 		};
// 		await placeOrder();
// 	}
// };
// export const getAllSellOrdersForToken = async (network: string, token: any) => {
...
// };
// export const getAllBuyOrdersForToken = async (network: string, token: any) => {
// 	const url = ONE_INCH_BASE_URL + network + ONE_INCH_LIMT_URL_ALL;
// 	const params = {
// 		takerAsset: token,
// 	};
...
// 	return response.json();
// };
// export const getUserOrders = async (network: string, walletAddress: string) => {
// 	const url =
// 		ONE_INCH_BASE_URL + network + ONE_INCH_LIMT_URL_ADDRESS + walletAddress;
...
// //     }
// // };
// export const getFillOrderData = (
// 	order: {
// 		displayOrder: { price: number };
// 		orderData: { data: any };
// 		signature: any;
// 	},
// 	amount: any,
...
// 	makerAmount = ethers.parseUnits("" + makerAmount, 18).toString();
// 	takerAmount = ethers.parseUnits("" + takerAmount, 18).toString();
// 	threshold = ethers.parseUnits("" + threshold, 18).toString();
// 	return {
// 		limitOrder: {
...
// 	}
// };
// export const getCancelOrderData = (order: { data: any }) => ({
// 	...order.data,
// 	permit: "0x",
// 	interaction: "0x",
// });
